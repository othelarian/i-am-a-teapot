export earl-html = <[
  a audio b body br button canvas div h1 h2 h3 h4 head hr img input li link
  meta p script span style table td th title tr ul
]>

export earl-svg = <[
  circle defs line path rect svg text use
]>
